...
class Authorize_check extends CI_Controller
{	
	...
	// Update Profile
	function update( $subscription_id="4894683" )
	{
		// Load the ARB lib
		$this->load->library('authorize_arb');
	...
	// Cancel Profile
	function cancel( $subscription_id="4894641" )
	{
		// Load the ARB lib
		$this->load->library('authorize_arb');
