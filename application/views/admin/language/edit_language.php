            ...
            <form  id="language_form" class="form-horizontal ui-formwizard" method="post" novalidate="novalidate">
              <div id="form-wizard-1" class="step ui-formwizard-content" style="display: block;">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input  type="text" value="<?php echo $edit_language[0]->lang_name; ?>"  name="lang_name" id="lang_name" class="ui-wizard-content">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Lang Code</label>
                  <div class="controls">
                    <input  type="text" value="<?php echo $edit_language[0]->lang_code; ?>" name="lang_code" id="lang_code" class="ui-wizard-content">
                  </div>
                </div>
                <div class="control-group">
				  ...
				  <select id="lang_status" name="lang_status" class="ui-wizard-content">
					<option <?php if($edit_language[0]->status == 'Active'){ echo "selected=selected";}?> value="Active">Active</option>
					<option value="Inactive"<?php if($edit_language[0]->status == 'Inactive'){ echo "selected=selected";}?> value="Inactive">Inactive</option>
				  </select>
				  </div>
                </div>
              </div>
