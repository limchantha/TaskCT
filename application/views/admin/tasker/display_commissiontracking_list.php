			...
			<table id="dynamic-table" class="table table-bordered data-table">
													...
													<tbody>
														...
														<tr>															
															...
															<td><?php echo $task_list->total_task_amount;?></td>
															<td><?php echo $task_list->total_task_service_fee;?></td>
															<td><?php echo $task_list->total_task_amount-$task_list->total_task_service_fee;?></td>
															<td><?php echo $task_list->paid_amount;?></td>
															<td><?php echo ($task_list->total_task_amount-$task_list->total_task_service_fee)-$task_list->paid_amount;?></td>
															<td>
															<?php if((($task_list->total_task_amount-$task_list->total_task_service_fee)-$task_list->paid_amount)>0){?>
															<a class="btn btn-success" href="<?php echo base_url();?>admin/tasker/commission_tracking_detail/<?php echo $task_list->tasker_id;?>">
															Pay</a><?php } else{ echo'-';} ?></td>
