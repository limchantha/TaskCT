          ...
          <div class="widget-content nopadding">
			<table id="dynamic-table" class="table table-bordered data-table">
													...
													<tbody>
														...
														<tr>															
															<td><?php echo $i;?></td>
															<td><?php echo $task_list->name;?></td>
															<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<?php if($prev==1 || (!empty($Payments) && in_array('2',$Payments))){?>												
																
																<a class="btn btn-success" href="<?php echo base_url();?>admin/payments/add_payments/<?php echo $task_list->id;?>">
																	Edit
																</a> 
																<?php } ?>
