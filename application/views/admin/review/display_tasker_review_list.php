			...
			<table id="dynamic-table" class="table table-bordered data-table">
													...
													<tbody>
														...
														<tr>															
															...
															<td><a class="btn btn-<?php echo $task_list->status=='1'?'success':'danger';?>" href="<?php echo base_url();?>admin/review/tchange_status/<?php echo $task_list->id;?>/<?php echo $task_list->status=='1'?0:1;?>">
																<?php echo $task_list->status==1?"Active":"Inactive";?></a></td>
															<td>
															<div class="hidden-sm hidden-xs action-buttons">
																	
																<?php if($prev==1 || (!empty($Reviews) && in_array('2',$Reviews))){?>
																
																<a class="btn btn-success" href="<?php echo base_url();?>admin/review/add_review/<?php echo $task_list->id;?>">
																	Edit
																</a>
																<?php } ?>
																<?php if($prev==1 || (!empty($Reviews) && in_array('3',$Reviews))){?>
																
																<a onclick="return confirm('Once deleted cant be recover again...');" class="btn btn-danger" href="<?php echo base_url();?>admin/review/tdelete_task_review/<?php echo $task_list->id;?>">
																	Delete
																</a>
																<?php } ?>
															</div>													
