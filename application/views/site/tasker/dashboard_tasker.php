			...
			<div class="content_base aft_login_content">
					<div class="container">
						<div class="head_title col-md-12 col-sm-12 col-xs-12 nopadd text-center">
                            <h1><?php echo  $this->lang->line('welcometo'); ?>, <?php echo $user->first_name==''?'Guest':ucfirst($user->first_name);?></h1>
						</div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 how_works text-center">
								<h5><?php echo  $this->lang->line('how_it_works'); ?> ?</h5>
                                <h6><?php echo  $this->lang->line('simple_and_easy_steps'); ?></h6>
								<div class="how_icons">
