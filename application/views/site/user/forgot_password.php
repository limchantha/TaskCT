                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center nopadd">
                                    <div class="col-md-5 col-sm-8 col-xs-12 sign_start sign_in_custom nopadd">
                                        ...
                                        <div class="sign_base sign_in new_sign_in_logo">
                                            <form action="" method="post" id="forgot-form" novalidate="novalidate">		
												<input type="email" name="login_email" placeholder="Email Address" class="form-control">
												<div class="col-md-12 col-sm-12 col-xs-12 full_submit_login nopadd">
												<div class="col-md-6 col-sm-6 col-xs-12 full_submit_login nopadd">
													<input type="submit" value="Reset Password" class="submit_btn custom_submit">
												</div>
												<div class="col-md-6 col-sm-6 col-xs-12 full_submit_login text-left">
												  <p class="custom_forgot1"> Or <a href="<?php echo base_url();?>user_login" class="">
												  Login</a></p>
												 </div>
												  </div>
											</form>
