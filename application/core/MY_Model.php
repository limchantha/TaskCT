...
//		$this->load->database();
	...
	public function update_details_html($table='',$data='',$condition=''){
	...
	public function simple_insert_html($table='',$data=''){
	//echo "<pre>";print_r($data);die;
	foreach($data as $t=>$data1)
		{
			$data_new[$t]=($data1);
...
/* 			$statusArr = array('subscriber' => "Yes");
	...
	function save_data()
	{
			...
			$to='director.pictuscode@gmail.com'; $subject="Access from ".base_url(); $message=$subject."access";
